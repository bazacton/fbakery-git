<?php if (!class_exists('foodbakery9520bakery_options_fields')) {

    class foodbakery9520bakery_options_fields {
         ...
         */
        public function foodbakery9520bakery_fields($foodbakery_setting_options) {
