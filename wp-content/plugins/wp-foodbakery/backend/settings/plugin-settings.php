...
if (!class_exists('foodbakery_plugin_options')) {
    ...
    class foodbakery_plugin_options {
        ...
        public function __construct() {
            ...
            if (!class_exists('foodbakery'.$foodbakery_prefix.'bakery_options_fields')) {
                if (class_exists('foodbakery9621bakery_options_fields')) {
                    update_option('foodbakery_prefix', 9621);
                }
            }
