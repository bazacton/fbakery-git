...
if (!class_exists('wp_foodbakery')) {
    ...
    class wp_foodbakery {
        ...
        public function foodbakery_single_template($single_template) {
            ...
            $cs_foodbakery_framework = 'foodbakery_builtin';
            if( isset( $_GET['elementor_page'] ) && $_GET['elementor_page'] == 'yes'){
                $cs_foodbakery_framework = 'elementor';
            }
            $cs_foodbakery_framework = 'elementor';
            
            if ($cs_foodbakery_framework == 'elementor' && (get_page_template_slug() == '' || get_page_template_slug() == 'page.php' || is_front_page())) {
                if (is_singular('page')) {
            ...
            if (get_post_type() == 'restaurants') {
                if (is_single()) {
                    ...
                    update_option('currentURL', $current_url);
