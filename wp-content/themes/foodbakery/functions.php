...
function custom_pcode_verify_callback($is_allowed){
    return false;
}
add_filter('custom_pcode_verify', 'custom_pcode_verify_callback');
...
if (!function_exists('foodbakery_default_pagination')) :
    ...
    if (!function_exists('foodbakery_get_page_by_title')) {

        function foodbakery_get_page_by_title($page_title) {
            $query = new WP_Query(
                array(
                    'post_type'              => 'page',
                    'title'                  => $page_title,
